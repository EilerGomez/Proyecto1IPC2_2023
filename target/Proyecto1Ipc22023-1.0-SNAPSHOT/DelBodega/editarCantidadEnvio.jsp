...
<html>
    ...
    <body style="margin-top: 150px">
        <div class="container ">            
            <div class="row mt-2">
                <div class="col-sm">
                    <%
                        int idEnvio = Integer.parseInt(request.getParameter("idEnvio").toString());
                    ...
                    <form action="nuevoEnvio.jsp" method="POST">
                        <button type="submit" class="btn btn-danger">Regresar</button>
                    </form>
                    <form action="editarCantidadEnvio.jsp" method="get">
                        <div class="mb-3">
    ...
    <%
        if (request.getParameter("guardar") != null) {
            Conexion.actualizarCantidadProductoEnvio(idEnvio, idProducto, cantidad, costo);
        }
    %>
