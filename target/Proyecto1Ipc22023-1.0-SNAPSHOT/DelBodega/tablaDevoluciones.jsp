                    ...
                    <form method="get">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <%
                                    Conexion.traerTodasDevolucines(Integer.parseInt(sesion.getAttribute("id").toString()));
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="DelBodega/descripcionDevolucion.jsp?idDevolucion=<%=Conexion.rs.getString(1)%>">
