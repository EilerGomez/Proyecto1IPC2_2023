...
<html>
    ...
    <body style="margin-top: 90px; background: #fee9e9">
        <div class="container ">            
            <div class="row mt-2">
                <div class="col-sm">
                    <h3>Pedidos de la incidencia: <%=request.getParameter("idIncidencia")%> </h3>
            ...
            <a type="submit" class="btn btn-danger" href="tablaIncidenciasSolucionadasPorTiendaYFecha.jsp?desde=<%=desde%>&hasta=<%=hasta%>&tienda=<%=tienda%>">Regresar</a>
        </div>
    </body>
</html>
