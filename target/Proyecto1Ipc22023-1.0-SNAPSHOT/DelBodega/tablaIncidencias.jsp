...
<html>
    ...
    <body>
        ...
        <div class="container ">            
            <div class="row mt-2">
                <div class="col-sm">
                    <h2>Incidencias hechas hacia la bodega</h2>
                    <form method="get">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <%
                                    Conexion.traerTodasIncidencias(Integer.parseInt(sesion.getAttribute("id").toString()));
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="DelBodega/descripcionIncidencia.jsp?idIncidencia=<%=Conexion.rs.getString(1)%>">
