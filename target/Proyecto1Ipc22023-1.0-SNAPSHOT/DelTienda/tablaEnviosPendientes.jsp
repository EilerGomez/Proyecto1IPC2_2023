...
<html>
    ...
    <body>
        ...
        <div class="container ">            
            <div class="row mt-2">
                <div class="col-sm">
                    <h2>Envios pendientes por recibir en la tienda <%=sesion.getAttribute("tienda")%></h2>
                    <form method="get">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <%
                                    Conexion.traerEnviosDespachados(Integer.parseInt(sesion.getAttribute("tienda").toString()));
