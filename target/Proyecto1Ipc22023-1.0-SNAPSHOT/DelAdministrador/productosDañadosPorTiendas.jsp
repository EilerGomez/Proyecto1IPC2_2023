...
<html>
    <head>
        ...
        <title>Producto mas pedido</title>
    </head>
    <body>
        <div class="container">
            <div class="row mt-2">
                <div class="col-sm">
                    <form class="form-control" action="DelAdministrador/tablaProductosDañadosPorTiendas.jsp">
                        <label>Ingrese el rango para buscar el producto</label>
                        <br></br>
