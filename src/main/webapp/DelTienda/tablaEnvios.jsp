...
<html>
    ...
    <body>
        ...
        <div class="container ">            
            <div class="row mt-2">
                <div class="col-sm">
                    <h2>Envios realizados a la tienda <%=sesion.getAttribute("tienda")%></h2>
                    <form method="get">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <%
                                    Conexion.traerEnviosPorCodigoTienda(Integer.parseInt(sesion.getAttribute("tienda").toString()));
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="DelTienda/descripcionEnvio.jsp?idEnvio=<%=Conexion.rs.getString(1)%>">
