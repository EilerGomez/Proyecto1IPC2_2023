...
<html>
    ...
    <body>
        <div class="container">
            <div class="row mt-2">
                <div class="col-sm">
                    <form class="form-control" action="DelTienda/tablaIncidenciasEnXTiempoYEstado.jsp">
                        <label>Ingrese el rango para especificar las incidencias</label>
                        <br></br>
                        ...
                        <br></br>
                        <label id="subtitulo3">ESTADO DE LA INCIDENCIAS</label>   
