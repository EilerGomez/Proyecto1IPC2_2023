...
<html>
    ...
    <body>
        ...
        <div class="container ">            
            <div class="row mt-2">
                <div class="col-sm">
                    <h2>Pedidos PENDIENTES de las tiendas supervisadas</h2>
                    <form method="get">
                        <table class="table table-dark table-striped">
                            ...
                            <tbody>
                                ...
                                <%
                                    Conexion.traerPedidosPendientes();
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="DelSupervisor/aprobarPedidosPendientes.jsp?idPedido=<%=Conexion.rs.getString(1)%>">
