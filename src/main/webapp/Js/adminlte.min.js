...
!(function (i) {
      ...
      i.get(
        ...
        function (t) {
          this.options.loadInContent &&
            i(this.element).find(this.options.content).html(t),
  ...
  (function (i) {
    ...
    (s.prototype.init = function () {
      (this.options.expandOnHover || i("body").is(l + h)) &&
        (this.expandOnHover(), i("body").addClass(g)),
        i(o).click(
          function () {
            i(window).width() <= this.options.collapseScreenSize &&
              i("body").hasClass(p) &&
              this.close();
          }.bind(this)
        ),
      ...
      (s.prototype.open = function () {
        i(window).width() > this.options.collapseScreenSize
          ? i("body").removeClass(f).trigger(i.Event(v))
          : i("body").addClass(p).trigger(i.Event(v));
      }),
      (s.prototype.close = function () {
        i(window).width() > this.options.collapseScreenSize
          ? i("body").addClass(f).trigger(i.Event(b))
          : i("body")
              .removeClass(p + " " + f)
              .trigger(i.Event(b));
      }),
    ...
    (i.prototype.activate = function () {
      this.fix(),
        ...
        this.options.resetHeight &&
          a("body, html, " + d).css({ height: "auto", "min-height": "100%" }),
        this.bindedResize ||
          (a(window).resize(
            function () {
              this.fix(),
      ...
      (i.prototype.fix = function () {
        ...
        if (a("body").hasClass(g)) a(l).css("min-height", n - t);
          ...
          s =
            i + e <= n
              ? (a(l).css("min-height", n - o), n - o)
              : (a(l).css("min-height", i), i);
          var r = a(u);
      ...
      (i.prototype.fixSidebar = function () {
        a("body").hasClass(g)
          ...
          : void 0 !== a.fn.slimScroll &&
            a(p).slimScroll({ destroy: !0 }).height("auto");
      });
    var m = a.fn.layout;
    (a.fn.layout = b),
